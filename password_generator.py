...
weakradioButton=Radiobutton(root,text='Weak Password',value=1,variable=choice,font=('arial',20,'italic','bold'),fg='Grey')
weakradioButton.grid(pady=10)

mediumradioButton=Radiobutton(root,text='Medium Password',value=2,variable=choice,font=('arial',20,'italic','bold'),fg='Yellow')
mediumradioButton.grid(pady=10)

strongradioButton=Radiobutton(root,text='Strong Password',value=3,variable=choice,font=('arial',20,'italic','bold'),fg='Green')
...
print("Made with Love from VIGYAN")
root.mainloop()